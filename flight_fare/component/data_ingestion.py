...
class DataIngestion:
    ...
    def download_flight_fare_data(self,) -> str:
        try:
            ...
            flight_fare_file_name = os.path.basename(download_url)

            tgz_file_path = os.path.join(tgz_download_dir, flight_fare_file_name)
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            with tarfile.open(tgz_file_path) as flight_fare_tgz_file_obj:
                flight_fare_tgz_file_obj.extractall(path=raw_data_dir)
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            flight_fare_file_path = os.path.join(raw_data_dir,file_name)
    ...
    def initiate_data_ingestion(self)-> DataIngestionArtifact:
        try:
            tgz_file_path =  self.download_flight_fare_data()
